...
$(document).on('click', '.play-button', function(e) {
    ...
    if (MR.Characters.SelectedChar !== null) {
        ...
        MR.Characters.Functions.Notify("fas fa-user-friends", "Karakters", "Нямате избран герой.", "#e74c3c", 500);
    }
});
