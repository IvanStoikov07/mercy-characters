...
RegisterNUICallback('cDataPed', function(Data)
    ...
    if cData ~= nil then
        ISFramework.Functions.TriggerCallback('mr-characters:server:getSkin', function(model, data)
...
RegisterNUICallback('SetupCharacters', function()
    ISFramework.Functions.TriggerCallback("mr-characters:server:get:char:data", function(result)
        SendNUIMessage({
